...
- **Selector de perfil del cuarteto**: Player · Player2 · Player3 · Player4 — todo el dash se recalcula
...
- Audita las competitivas de Player contra las **Reglas de sesión** del plan: regla de parada (2 derrotas seguidas con K/D < 0.9 = cerrar sesión), violaciones de **pool** con su costo en RR y separación por sesiones (pausa ≥ 3 h)
...
|---|---|---|
| `VAL_NAME` / `VAL_TAG` | `Player` / `LAN` | Riot ID del perfil principal |
